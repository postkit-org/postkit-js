...
export type PostkitRelatedContentSlot =
  (typeof postkitRelatedContentSlots)[number];
...
export type PostkitSeriesNavigationSlot =
  (typeof postkitSeriesNavigationSlots)[number];
...
export type PostkitAudienceBoundarySlot =
  (typeof postkitAudienceBoundarySlots)[number];
