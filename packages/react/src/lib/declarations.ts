...
export interface PostkitDeclarationManifest {
  ...
  readonly components: Readonly<
    Record<PostkitComponentName, PostkitComponentDeclaration>
  >;
}
...
} satisfies Readonly<Record<string, PostkitPropDeclaration>>);
...
} satisfies Partial<Record<PostkitComponentName, PostkitComponentDeclaration>>;
...
function publicationDeclaration(
  name: PostkitComponentName,
  directive: string,
  description: string,
  props: Readonly<Record<string, PostkitPropDeclaration>>,
  childMode: 'none' | 'mdx' = 'none',
): PostkitComponentDeclaration {
  return {
    name,
    directive,
    description,
...
const publicationDeclarations = {
  AudienceBoundary: publicationDeclaration(
    'AudienceBoundary',
    'postkit-audience-boundary',
    'An authored audience marker with a host-controlled visibility boundary.',
    {
      audience: {
        kind: 'string',
        required: true,
  ...
  Comparison: publicationDeclaration(
    'Comparison',
    'postkit-comparison',
    'An accessible feature and option comparison table.',
    {
      columns: {
        kind: 'json',
        required: true,
  ...
  KeyTakeaway: publicationDeclaration(
    'KeyTakeaway',
    'postkit-key-takeaway',
    'A highlighted summary or list of essential points.',
    {
  ...
  Poll: publicationDeclaration(
    'Poll',
    'postkit-poll',
    'An interactive reader poll whose submission handler is host-owned.',
    {
      question: {
        kind: 'string',
        required: true,
  ...
  ProductCard: publicationDeclaration(
    'ProductCard',
    'postkit-product-card',
    'A product or recommendation card with explicit commercial linking.',
    {
      title: {
        kind: 'string',
        required: true,
  ...
  PullQuote: publicationDeclaration(
    'PullQuote',
    'postkit-pull-quote',
    'A prominent quotation with optional attribution and citation.',
    {
      quote: {
        kind: 'string',
        required: true,
  ...
  RelatedContent: publicationDeclaration(
    'RelatedContent',
    'postkit-related-content',
    'A semantic list of related articles or resources.',
    {
      items: {
        kind: 'json',
        required: true,
  ...
  SeriesNavigation: publicationDeclaration(
    'SeriesNavigation',
    'postkit-series-navigation',
    'Previous and next navigation for a named article series.',
    {
      title: {
        kind: 'string',
        required: true,
  ...
  SponsorBlock: publicationDeclaration(
    'SponsorBlock',
    'postkit-sponsor-block',
    'A clearly disclosed sponsor message and destination.',
    {
      name: {
        kind: 'string',
        required: true,
  ...
  Stat: publicationDeclaration(
    'Stat',
    'postkit-stat',
    'A prominent metric with context and trend.',
    {
      value: {
        kind: 'string',
        required: true,
...
export const postkitDeclarationManifest = Object.freeze({
  ...
  components: {
    ...
    AppearsOn: {
      ...
      description:
        'A provenance-aware list of destinations where the post was syndicated.',
      childMode: 'none',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
    ...
    AuthorCard: {
      ...
      description:
        'A semantic author biography with portrait and profile links.',
      childMode: 'mdx',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
        ...
        links: {
          kind: 'json',
          description:
            'A JSON array of author links with label, href, and optional rel fields.',
        },
        presentation: {
          kind: 'enum',
    ...
    CallToAction: {
      ...
      description:
        'A focused article callout with primary and secondary actions.',
      childMode: 'mdx',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
    ...
    Figure: {
      ...
      description:
        'A responsive image with an optional caption and attribution.',
      childMode: 'none',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
        ...
        alt: {
          ...
          required: true,
          description:
            'Alternative text, or an explicitly empty value for a decorative image.',
        },
        caption: {
          kind: 'string',
    ...
    LinkPreview: {
      ...
      description:
        'A portable inline link, metadata card, native media player, or isolated rich embed.',
      childMode: 'none',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
        ...
        presentation: {
          ...
          description:
            'The requested link treatment. Auto chooses from resolved metadata.',
        },
        images: {
          kind: 'enum',
        ...
        activation: {
          ...
          description:
            'Whether an external interactive embed waits for reader consent.',
        },
        provider: {
          kind: 'string',
          description:
            'A provider override for PostkitProvider, an editor, or a build-time resolver integration.',
        },
        metadata: {
          kind: 'json',
          description:
            'A normalized @postkit/unfurl result serialized as JSON.',
        },
        title: {
          kind: 'string',
    ...
    NewsletterSignup: {
      ...
      description:
        'A provider-agnostic newsletter form connected by PostkitProvider.',
      childMode: 'mdx',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
    ...
    ShareActions: {
      ...
      description:
        'Reader-initiated native, copy, email, and configured social sharing actions.',
      childMode: 'none',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
    ...
    SocialPost: {
      ...
      description:
        'A consistently styled social post card or consent-gated provider embed.',
      childMode: 'none',
      directiveRemarkPlugins: ['directives', 'postkit'],
      props: {
        ...postkitPresentationProps,
        ...
        resolution: {
          ...
          description:
            'Whether Postkit resolves the current post, renders frozen metadata, or falls back to live resolution when no snapshot exists.',
        },
        snapshotInfo: {
          kind: 'enum',
          values: ['auto', 'visible', 'hidden'],
          description:
            'Whether snapshot capture provenance is displayed in the rendered card.',
        },
        service: {
          kind: 'string',
        ...
        metadata: {
          kind: 'json',
          description:
            'A normalized social post, unfurl result, or versioned Postkit snapshot envelope.',
        },
        authorName: {
          kind: 'string',
...
} satisfies PostkitDeclarationManifest);

export function postkitDeclarationFor(
  name: PostkitComponentName,
): PostkitComponentDeclaration {
