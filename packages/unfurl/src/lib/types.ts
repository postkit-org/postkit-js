export type BuiltInLinkResolverId =
  'opengraphs' | 'iframely' | 'embedly' | 'microlink';

export type LinkResolverId =
  BuiltInLinkResolverId | (string & Record<never, never>);
...
export type ResolvedLinkRequesterFamily =
  | 'GENERIC'
  | 'SLACK'
  | 'LINKEDIN'
  | 'X'
